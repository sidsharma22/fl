...
class Preprocess():
    ...
    def sample_without_replacement(
        ...
        data_array = np.zeros((num_samples, 28, 28)) #---------------------
    ...
    def visualize_trainloader(self,trainloaders):
        ...
        plt.savefig('../output/setup_data/train_data_distribution.png', dpi=300, format='png', bbox_inches='tight')
    ...
    def visualize_valloader(self,valloaders):
        ...
        plt.xlabel("Clients IDs")
        plt.ylabel("Class Labels")
        plt.savefig('../output/setup_data/val_data_distribution.png', dpi=300, format='png', bbox_inches='tight')
